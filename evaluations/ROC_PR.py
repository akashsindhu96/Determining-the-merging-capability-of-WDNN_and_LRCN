...
def PR(model, X1_test, X2_test, y_test, bccdc=False):
    y_pred_keras_tmp = model.predict([X1_test, X2_test])
    y_pred_keras = []
    y_test_tmp = []
    scores_sr = []
    scores_pr = []
...
def ROC(model, X1_test, X2_test, y_test, name, multi=False, limited=False, bccdc=False):
    y_pred_keras_tmp = model.predict([X1_test, X2_test])
    y_pred_keras = []
    y_test_tmp = []
    scores = []
